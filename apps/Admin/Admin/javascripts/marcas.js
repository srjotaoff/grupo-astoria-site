  ...
  card.innerHTML =
    ...
    '<div class="main_tudo_caixas_caixa_conjunto">' +
      ...
      '<select class="main_tudo_caixas_caixa_texto" data-field="empresa">' +
        ...
        '<option value="Chocosul"' + ((parceiro && parceiro.empresa) === 'Chocosul' ? ' selected' : '') + '>Chocosul</option>' +
        '<option value="Mastter"'  + ((parceiro && parceiro.empresa) === 'Mastter'  ? ' selected' : '') + '>Mastter</option>' +
      '</select>' +
    '</div>' +
